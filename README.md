...
This project uses **Python (Flask)** for the backend, **Scikit-Learn** for machine learning models, and a **premium monochromatic dark-themed HTML/CSS/JS frontend** for user interaction. It is fully self-contained, self-generating historical datasets, and has a dedicated guide for college project presentations.
...
* **College Presentation Resource**: Contains an educational About page detailing the ML flow and a Viva-Voce guide.
...
│   └── about.html             # ML workflow & presentation credits
...
Here are three common questions external examiners ask during projects and how you should answer them:

1. **Q: What is a Random Forest and how does it work?**
   * *A:* Random Forest is an ensemble learning method that fits multiple Decision Trees on bootstrap subsets of the dataset and merges their predictions (voting for classification, averaging for regression). It reduces model variance and overfitting compared to a single decision tree.
